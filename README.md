...
1. Download `Ecclesia-Desktop-Setup-1.0.7.exe` from the [latest release](https://github.com/sujithrex/Ecclesia-desktop/releases/latest)
2. Run the installer
...
### macOS
1. Download `Ecclesia-Desktop-1.0.7-darwin-x64.zip` from the [latest release](https://github.com/sujithrex/Ecclesia-desktop/releases/latest)
...
**Debian/Ubuntu (.deb)**
```bash
wget https://github.com/sujithrex/Ecclesia-desktop/releases/download/v1.0.7/ecclesia-desktop_.deb
sudo dpkg -i ecclesia-desktop_.deb
```

**Fedora/RHEL (.rpm)**
```bash
wget https://github.com/sujithrex/Ecclesia-desktop/releases/download/v1.0.7/ecclesia-desktop-1.0.7-1.x86_64.rpm
sudo rpm -i ecclesia-desktop-1.0.7-1.x86_64.rpm
```
