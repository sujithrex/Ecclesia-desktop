...
**Debian/Ubuntu (.deb)**
```bash
wget https://github.com/sujithrex/Ecclesia-desktop/releases/download/v1.0.0/ecclesia-desktop_1.0.0_amd64.deb
sudo dpkg -i ecclesia-desktop_1.0.0_amd64.deb
```

**Fedora/RHEL (.rpm)**
```bash
wget https://github.com/sujithrex/Ecclesia-desktop/releases/download/v1.0.0/ecclesia-desktop-1.0.0-1.x86_64.rpm
sudo rpm -i ecclesia-desktop-1.0.0-1.x86_64.rpm
```
