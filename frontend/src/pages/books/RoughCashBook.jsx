      ...
      <div className="book-page-container">
        ...
        <main className="book-page-main">
          <div className="book-page-content">
            <h1 className="book-title">Rough Cash Book - {pastorate?.pastorateShortName || 'Pastorate Name'}{year ? ` (${year.year})` : ''}</h1>
          </div>
        </main>
      </div>
    </>
